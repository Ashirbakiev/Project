...
import ColorDiv from "./ColorDiv.tsx";
import ContainerRow from "./ContainerRow.tsx";
import RoundedButton from "./RoundedButton.tsx";
import MuteSVG from "./MuteSVG.tsx";
import UnmuteSVG from "./UnmuteSVG.tsx";
  ...
  return (
    <div
      className={`mx-auto flex flex-col h-screen ${
        wrong ? "bg-bgcolor2" : "bg-[url('/src/assets/images/2a560e71cdc81b64070ce8d8a5dfe8c7.jpg')] bg-cover bg-center "
      }`}
    >
      ...
      {/* Up Row */}
      <ContainerRow>
        <ContainerRow cname="flex-wrap xs:w-4/5 sm:w-3/4 md:w-2/4 lg:w-2/5 xl:w-2/5 bg-bgcolor3 rounded-3xl ">
          {initArray.map((color) => {
            let bgColor = "";
            if (color === "yellow") {
              bgColor = "bg-yellow";
